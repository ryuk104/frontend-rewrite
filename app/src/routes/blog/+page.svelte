<script lang="ts">
  import IndexProfile from '$lib/components/Blog/index_profile.svelte';
  import IndexPosts from '$lib/components/Blog/index_posts.svelte';
  import Tags from '$lib/components/Blog/tags_root.svelte';
