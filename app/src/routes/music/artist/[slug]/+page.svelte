<script lang="ts">
	import Carousel from "$lib/components/Music/Carousel/Carousel.svelte";
	import ArtistPageHeader from "../../../lib/components/Music/ArtistPageHeader/ArtistPageHeader.svelte";
	import { page } from "$app/stores";

	import ListItem from "$lib/components/Music/ListItem/ListItem.svelte";
	import { isPagePlaying } from "$lib/stores/stores";
	import Header from "$lib/components/Music/Layouts/Header.svelte";
	...
	import Description from "$components/Music/ArtistPageHeader/Description";
...
<style lang="scss">
	@import "../../../lib/components/Music/ArtistPageHeader/index.scss";
	.song-list {
