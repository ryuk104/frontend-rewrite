...
//用户是否登录
export const isLoginStore = writable('isLogin');
...
//自动滚动
export const restoreScrollStore = writable('restoreScroll');
//音质
export const musicQualityStore = writable('musicQuality');
//是否显示歌词翻译
export const isShowTranslateStore = writable('isShowTranslate');
//当前歌手详情 id，用于刷新歌手详情页
export const currentDetailSongerIdStore = writable(0);
//解决歌手全部歌曲不返回歌曲封面问题
export const coverImgUrlStore = writable('');
//是否显示热评入口
export const isShowCommentStore = writable('isShowComment');
