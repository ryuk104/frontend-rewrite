...
<button role="switch" aria-checked="true" aria-label="Mute" type="button" class="button enabled button lookBlank colorBrand grow">
    <div class="contents">
        <svg aria-hidden="false" width="20" height="20" viewBox="0 0 24 24">
            ...
            <path d="M21 4.27L19.73 3L3 19.73L4.27 21L8.46 16.82L9.69 15.58L11.35 13.92L14.99 10.28L21 4.27Z" class="strikethrough" fill="currentColor"></path>
        </svg>
    </div>
</button>

<button role="switch" aria-checked="false" aria-label="Deafen" type="button" class="button enabled button lookBlank colorBrand grow">
    <div class="contents">
        <svg aria-hidden="false" width="20" height="20" viewBox="0 0 24 24">
...
<button aria-label="User Settings" type="button" class="button enabled button lookBlank colorBrand grow">
    <div class="contents">
        <svg aria-hidden="false" width="20" height="20" viewBox="0 0 24 24">
