...
<script lang="ts">
import userStatuses from "$lib/constants/userStatuses";
import { AppUpdateModule } from "$lib/store/modules/appUpdate";
import { DrawersModule } from "$lib/store/modules/drawers";
import { FriendsModule, FriendStatus } from "$lib/store/modules/friends";
import { LastSeenServerChannelsModule } from "$lib/store/modules/lastSeenServerChannel";
import { LastSelectedServersModule } from "$lib/store/modules/lastSelectedServer";
import { MeModule } from "$lib/store/modules/me";
import { NotificationsModule } from "$lib/store/modules/notifications";
import { PopoutsModule } from "$lib/store/modules/popouts";
import { PresencesModule } from "$lib/store/modules/presences";
import { ReactiveLocalStorageModule } from "$lib/store/modules/reactiveLocalStorage";
...
import NavBarInCall from "$lib/components/NavBarInCall.svelte"
