...
import { DrawersModule } from "$lib/store/modules/drawers";
  ...
  export let leftStyle = { transform = "0" } as any;
  export let rightStyle = { transform = "0" } as any;
  export let leftDrawerTouch = false;
  export let rightDrawerTouch = false;
  export let startX = 0;
  export let startY = 0;
  export let touchStamp = 0;
  export let pauseTouches = false;
