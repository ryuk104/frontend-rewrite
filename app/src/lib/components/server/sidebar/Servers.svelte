<script lang="ts">
import { ServersModule } from "$ib/store/modules/servers";
import ServerTemplate from "./ServerTemplate.svelte";
import Draggable from "vuedraggable";
import Server from "$ib/interfaces/Server";
import { changeServerPosition } from "$ib/services/serverService";
import { LastSelectedServersModule } from "$ib/store/modules/lastSelectedServer";
