<script lang="ts">
  import type { Post } from '$lib/types/blog/post';
  import { browser } from '$app/environment';
  import { siteConfig, navConfig, mobilenavConfig } from '../../../testdb/site';
  import { theme } from '$stores/blog/themes';
  import { fly, fade } from 'svelte/transition';
  import Dropdown from '$lib/components/Blog/dd.svelte';
  import { tagsCur, tagsShowMobile, tagsShowDesktop } from '$stores/blog/tags';
  import { postsShow } from '$stores/blog/posts';
  import { navigating, page } from '$app/stores';
  import { postsAll } from '$stores/blog/posts';
  import AuthorAvatar from '$lib/components/Blog/image_avatar.svelte';
